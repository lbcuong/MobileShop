...
{
    public class PhoneCasesController : Controller
    {
        private readonly MobileShopContext _context;
        private readonly UserManager<MobileShopUser> _userManager;
        private readonly RoleManager<IdentityRole> _roleManager;

        public PhoneCasesController(MobileShopContext context, UserManager<MobileShopUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> SendReview(int itemId, string comment, int rate)
        {
            ...
            return RedirectToAction("Detail", "PhoneCases", new { id = itemId });
        }
