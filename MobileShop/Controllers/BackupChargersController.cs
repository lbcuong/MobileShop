...
{
    public class BackupChargersController : Controller
    {
        private readonly MobileShopContext _context;
        private readonly UserManager<MobileShopUser> _userManager;
        private readonly RoleManager<IdentityRole> _roleManager;

        public BackupChargersController(MobileShopContext context, UserManager<MobileShopUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> SendReview(int itemId, string comment, int rate)
        {
            ...
            return RedirectToAction("Detail", "BackupChargers", new { id = itemId });
        }
